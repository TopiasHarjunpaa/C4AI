...
class TestBoardService(unittest.TestCase):
    ...
    def test_after_reset_there_are_only_grid_sprite(self):
        self.board.add_coin(0, 5, 1)
        self.assertEqual(len(self.board.sprites.all_sprites), 2)
        self.board.reset()
        self.assertEqual(len(self.board.sprites.all_sprites), 1)
    ...
    def test_add_coin_creates_sprites_correctly(self):
        ...
        self.assertEqual(len(self.board.sprites.all_sprites), 4)
