...
class AiService:
    ...
    def calculate_move_randomly(self):
        ...
        This is just for early testing purpose which may deleted later.

        Returns:
            int: Index of the chosen column.
        """

        available_locations = self._situation.get_available_locations(
            self._situation.get_game_grid())
        location = random.choice(available_locations)
        return location

    def calculate_next_move(self, grid, player_number):
        """Calculates one of the possible moves using heurestic calculation.
        This spare method which may be deleted later.
    ...
    # Add docstring and rename the function
    ...
    def count_values(self, loc, player_number):
        ...
        of cell values (0, 1, 2) which can be in any directions at the grid
        ...
        Returns:
            int: Return total value in line of connect
        """
